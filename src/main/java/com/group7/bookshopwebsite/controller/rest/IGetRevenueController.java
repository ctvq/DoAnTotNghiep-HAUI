package com.group7.bookshopwebsite.controller.rest;
...
public interface IGetRevenueController {
    ...
    @GetMapping("/get-revenue/categories-by-month/{selectedMonth}")
    ResponseEntity<?> getCategoryRevenueByMonth(@PathVariable("selectedMonth") int selectedMonth) throws UnsupportedEncodingException;
